...
$count =0;
  ...
  $sql1 = "SELECT names,profile FROM query where CustomerID='$CustomerID'" ;
...
<img src="../images/profiles/<?php echo $row['profile'];?>" class="rounded-circle mr-1" alt="img" width="40" height="40">
...
$row = $names->fetch_row(); 
?>
<img src="../images/profiles/<?php echo $row[1];?>" class="rounded-circle mr-1" alt="IMG" width="40" height="40">
<?php }

else{
    ?>
    <img src="../images/profiles/noimage.png" class="rounded-circle mr-1" alt="IMG" width="40" height="40">
<?php
